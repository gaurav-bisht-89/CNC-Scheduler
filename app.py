...
# =====================================================================
# CONFIGURATION: LINKED DIRECTLY TO YOUR NEW GOOGLE SHEET
# =====================================================================
NEW_SHEET_ID = "1iuFMQHJssHz4z0_zW-HQ6gMTAnQiRiqB6m2_hboiOFc"

@st.cache_data(ttl=10) # Auto-refreshes data if you edit your Google Sheet cells
def load_clean_cloud_data(sheet_id, sheet_name):
    # This transforms the interactive sheet into a clean background CSV stream per tab
    csv_url = f"https://docs.google.com/spreadsheets/d/1iuFMQHJssHz4z0_zW-HQ6gMTAnQiRiqB6m2_hboiOFc/edit?usp=sharing"
    df = pd.read_csv(csv_url)
    
    # Strip hidden white spacing errors from headers and rows automatically
...
try:
    ...
    st.info("Ensure all sheets (Orders, RoutingMaster, MachineMaster, WorkingCalendar, Maintenance) have clean data rows.")
    st.stop()
